...
namespace CustomizeUserDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CustomizeUserDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CustomizeUserDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
